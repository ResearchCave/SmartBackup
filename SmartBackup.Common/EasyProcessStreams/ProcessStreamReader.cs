...
namespace Narkhedegs
{
    public sealed class ProcessStreamReader : TextReader
    {
        ...
        public ProcessStreamReader(StreamReader processStreamReader, System.Text.Encoding ReaderEncoder)
        {
            _processStream = processStreamReader.BaseStream;
            _pipe = new Pipe();
            _reader = new StreamReader(_pipe.OutputStream , ReaderEncoder);
